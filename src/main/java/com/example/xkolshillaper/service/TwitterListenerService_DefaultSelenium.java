...
@Service
public class TwitterListenerService_DefaultSelenium {

    private final ApplicationEventPublisher applicationEventPublisher;

    public TwitterListenerService_DefaultSelenium(ApplicationEventPublisher applicationEventPublisher) {
        this.applicationEventPublisher = applicationEventPublisher;
    }

    public void launchDriverLoginAndListenForNotifications(){
        DriverSetup driverSetup = getDriverSetupDefaultSelenium();
        loginInX(driverSetup.driver());
        printNewPosts(driverSetup.devTools());
    }

    private static DriverSetup getDriverSetupDefaultSelenium() {
    ...
    private void printNewPosts(DevTools devTools) {
